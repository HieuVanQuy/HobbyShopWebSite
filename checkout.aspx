...
<head>
    ...
    <link href='//bizweb.dktcdn.net/assets/themes_support/bootstrap.min.css?20170913e' rel='stylesheet' type='text/css' />
    <link href='//bizweb.dktcdn.net/assets/themes_support/nprogress.css?20170913e' rel='stylesheet' type='text/css' />
    <link href='//bizweb.dktcdn.net/assets/themes_support/font-awesome.min.css?20170913e' rel='stylesheet' type='text/css' />
    <link href='//bizweb.dktcdn.net/assets/themes_support/checkout.css?20170913e' rel='stylesheet' type='text/css' />

    <link href='//bizweb.dktcdn.net/100/172/651/checkout_stylesheet/226402/checkout.css?1503820229340' rel='stylesheet' type='text/css' />
    ...
    <script>
                    //<![CDATA[
                        (function() {
                            ...
                            s.src = '//bizweb.dktcdn.net/assets/javascripts/bizweb_stats_v2.js?v=9';
    ...
    <script>
var Bizweb = Bizweb || {};
Bizweb.store = 'super-store.bizwebvietnam.net';
Bizweb.theme = {"id":226402,"role":"main","name":"theme"};
Bizweb.template = '';
    </script>
...
<body class="body--custom-background-color ">
    ...
    <form method="post" action="" data-toggle="validator" class="content stateful-form formCheckout">
        <div class="wrap" context="checkout" define='{checkout: new Bizweb.Checkout(this,{ token: "287124ea632e44e4b4db7bdbddea4819" ,existCode: false, totalOrderItemPrice: 5050000.0000, discount: 0, shippingFee: 0, freeShipping: false, requiresShipping: true, code: "", settingLanguage: "vi", moneyFormat: "{{amount_no_decimals_with_comma_separator}}₫", discountLabel: "Miễn phí", districtPolicy: "optional", district: "", province:"" })}'>
            <div class='sidebar '>
                <div class="sidebar_header">
                    <h2>
                        <label class="control-label">Đơn hàng</label>
                        <label class="control-label">(2 sản phẩm)</label>
                    </h2>
                    <hr class="full_width" />
                </div>
                                        ...
                                        <tr class="product product-has-image clearfix">
                                            <td>
                                                <div class="product-thumbnail">
                                                    <div class="product-thumbnail__wrapper">
                                                        ...
                                                        <img src='//bizweb.dktcdn.net/thumb/thumb/100/172/651/products/ferroli-divo-ssn-45s-bm01-300x300.jpg?v=1488688788937' class='product-thumbnail__image' />
                                            ...
                                            <td class="product-info">
                                                <span class="product-info-name">
                                                    ...
                                                    Máy Nước Nóng Ferroli Divo SSN 4.5S (BM01) 4.5 kW
                                                </span>
                                            ...
                                            <td>
                                                <div class="product-thumbnail">
                                                    <div class="product-thumbnail__wrapper">
                                                        ...
                                                        <img src='//bizweb.dktcdn.net/thumb/thumb/100/172/651/products/sharp-es-s700ev-300x300.jpg?v=1488688546120' class='product-thumbnail__image' />
                                        ...
                                        <div>
                                            <div class="form-group">
                                                <div class="field__input-wrapper" bind-class="{ 'js-is-filled': billing_address.full_name }">
                                                    ...
                                                    <input name="BillingAddress.LastName" type="text" bind-event-focus="handleFocus(this)" bind-event-blur="handleFieldBlur(this)" class="field__input form-control" id="_billing_address_last_name" data-error="Vui lòng nhập họ tên" required bind="billing_address.full_name" runat="server"/>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="field__input-wrapper field__input-wrapper--select">
                                                    ...
                                                    <select class="field__input field__input--select form-control" name="BillingProvinceId" id="billingProvince" required data-error="Bạn chưa chọn tỉnh thành" bind-event-change="billingProviceChange('')" bind="BillingProvinceId" runat="server">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="section hidden-md hidden-lg">
                                <div class="form-group clearfix m0">
                                    <input class="btn btn-primary btn-checkout" data-loading-text="Đang xử lý" type="button" bind-event-click="paymentCheckout('AIzaSyDWReBlPxFt-i145Gsd502wOqRS0KXFHW4;AIzaSyAbtwApDToQWn7snVio3Y9PWFbcpdnOWdk;AIzaSyA5rJOu8wci0li24bnZ1WogMEH93p-DGlM')" value="ĐẶT HÀNG" runat="server" onserverclick="Unnamed_ServerClick"/>
                                </div>
    ...
    <script src='//bizweb.dktcdn.net/assets/themes_support/jquery-2.1.3.min.js?20170913e' type='text/javascript'></script>
    <script src='//bizweb.dktcdn.net/assets/themes_support/bootstrap.min.js?20170913e' type='text/javascript'></script>
    <script src='//bizweb.dktcdn.net/assets/themes_support/twine.min.js?20170913e' type='text/javascript'></script>
    <script src='//bizweb.dktcdn.net/assets/themes_support/validator.min.js?20170913e' type='text/javascript'></script>
    <script src='//bizweb.dktcdn.net/assets/themes_support/nprogress.js?20170913e' type='text/javascript'></script>
    <script src='//bizweb.dktcdn.net/assets/themes_support/money-helper.js?20170913e' type='text/javascript'></script>
    <script src='//bizweb.dktcdn.net/assets/themes_support/checkout.js?20170913e' type='text/javascript'></script>
